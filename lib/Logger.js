var Logger = require('winston'),
    ENV = process.env.LOG_LEVEL || process.env.FH_ENV,
...
function init() {
    ...
    if (ENV) {
        ...
        throw new Error(prefix + 'Deployed environment cannot be resolved. PLease check environment configuration.');
    }
...
function setEnvConfig(env) {
    ...
    case 'debug':
        ...
        break;
    default:
        console.log(prefix + ' Default develeopment environment detected, setting Loglevel to: ' + config.level + ', enabling colorised output.');
        break;
    }
};
